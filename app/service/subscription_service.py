...
class SubscriptionService:
    ...
    async def update_status(
        self, id: int, status: bool, session: AsyncSession
    ) -> Subscription:
    ...
    async def get_active_subcriptions_by_category(
        self, category: MailTypeCategory, session: AsyncSession
    ) -> List[Subscription]:
        return await SubscriptionRepository().get_active_subscriptions_by_category(
