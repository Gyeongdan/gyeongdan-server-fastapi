...
async def update_content_by_id(id: int, category: int, content: str, session: AsyncSession = Depends(get_db_session)):
    return await ManagerService().update_content(id, category, content, session)
